...
3. ¿Hay algún dato faltante (valor nulo) en tus datos?
4. ¿Hay valores duplicados? Por ejemplo, más de una muestra para un mismo paciente.
5. Describe las variables: de tipo numérico, de tipo categórico.
6. Filtrar el conjunto de datos: Filtros sencillos, filtros combinados.
7. ¿Qué nos puedes contar de tu conjunto de datos? 
- media
- mediana
- valores máximos y mínimos
8. Haz una figura (gráfico lineal, gráfico de cajas, gráfico de barras).
```
